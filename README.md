<p align="center">
  <img src="llamagent/assets/images/llamagent.png" width="220" alt="LlamAgent">
</p>
...
<p align="center">
  <img src="llamagent/assets/images/llamagent_work.png" alt="LlamAgent module architecture">
</p>
...
Set `config.agent_prompts` / `config.module_prompts` on a `Config` instance for
fine-grained tuning, or run `/prompts` in the CLI to list available slots and
their status.
