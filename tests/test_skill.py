...
class TestTagMatchingAndLLMFallbackFlow:
    ...
    def test_tag_matching_and_skill_index_flow(self, bare_agent, tmp_path, mock_llm_client):
        """Full tag matching and L3 skill index flow across multiple scenarios."""
